...
$query = "INSERT INTO `index`(`name`, `email`, `password`) VALUES ('$name','$email','$password')";
...
<div>
            ...
            <button type="submit" class="submit" name="btn">Sign In</button>
...
\
      ...
      <input type="password"  class="form-control" id="password" name="password">
                 ...
                 <button type="submit" class="submit" name="btn">Login</button> -->
